...
command-description-feedback-add = Добавляет прототип окна обратной связи указанным клиентам и открывает его, если этот прототип ещё не был в их списке.
...
cmd-givefeedbackpopup-desc = Отправляет выбранному игроку окно обратной связи.
cmd-givefeedbackpopup-help = Использование: givefeedbackpopup <playerUid> <prototypeId>
cmd-showfeedbackpopup-desc = Открыть окно обратной связи.
...
feedbackpopup-command-error-popup-send-fail = Не удалось отправить окно! Скорее всего, к указанной сущности не привязан разум.
