...
ent-ClothingShoesBootsSyndieFilled = { ent-ClothingShoesBootsCombat }
    .suffix = Наполненный, Метательный нож
    .desc = { ent-ClothingShoesBootsCombat.desc }
ent-SecureBriefings = секретные документы инструктажа
    .desc = Набор секретных документов для информирования новых сотрудников службы безопасности.
    .suffix = Не маппить
