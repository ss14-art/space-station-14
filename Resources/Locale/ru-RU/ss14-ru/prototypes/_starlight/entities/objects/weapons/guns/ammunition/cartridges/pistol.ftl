...
ent-CartridgePistolImprovised = кустарный патрон (.35 авто)
    .desc = Самодельная пистолетная пуля, в которой в качестве метательного вещества вместо пороха используется фосфор, что делает её гораздо менее эффективной.
