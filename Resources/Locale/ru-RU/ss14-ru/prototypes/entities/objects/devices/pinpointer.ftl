...
ent-PinpointerMothershipPiece = фрагмент пинпоинтера ядра
    .desc = Фрагмент пинпоинтера ядра. Вам нужно четыре таких, чтобы починить его.
ent-PinpointerMothershipRepaired = отремонтированный пинпоинтер ядра
    .desc = Ручное устройство отслеживания, указывающее направление к ядру Материнского корабля. Этот экземпляр видал лучшие времена.
