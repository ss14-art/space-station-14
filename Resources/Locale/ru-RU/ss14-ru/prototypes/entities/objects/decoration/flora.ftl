ent-BaseRock = валун
    .desc = Тяжелый, как очень тяжелая штука.
ent-BaseTree = { "" }
    .desc = Да, это дерево.
...
ent-FloraTreeChristmas01 = рождественская елка
    .desc = { ent-BaseTreeConifer.desc }
ent-FloraTreeChristmas02 = рождественская елка
