...
ent-GoldenPlunger = золотой вантуз
    .desc = Вантуз с пластиковым клапаном, покрытым тонким слоем золота, который выдаётся в благодарность за многолетнюю службу. Всё ещё используется для прочистки канализации.
ent-RagItem = тряпка
...
ent-WireBrushElectrical = электрическая проволочная щётка
    .desc = Жёсткая щётка из стальной проволоки с подвижной головкой, значительно облегчающая чистку.
