...
ent-CardDoor = картонная дверь
    .desc = { ent-BaseMaterialDoorNavMap.desc }
ent-IronstoneDoor = железнокаменная дверь
    .desc = Таинственная дверь, сделанная из камня, иссечённого рунами.
ent-EncrustedIronstoneDoor = инкрустированная железнокаменная дверь
