...
ent-BarSignTheLightbulb = Лампочка
    .desc = Кафе, популярное среди молей и мотыльков. Однажды его закрыли на неделю после того, как бармен использовала нафталин для обработки своей запасной униформы.
...
ent-BarSignEmped = глючная вывеска бара
    .desc = Кажется, хороший удар по ней может всё исправить.
