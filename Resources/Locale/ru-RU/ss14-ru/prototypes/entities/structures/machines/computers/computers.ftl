...
ent-ComputerNukieDelivery = компьютер доставки Синдиката
    .desc =
        Компьютер, способный переправлять через блюспейс определённое оборудование для ядерных оперативников. 
        Плата встроена в корпус, и её невозможно извлечь при деконструкции.
