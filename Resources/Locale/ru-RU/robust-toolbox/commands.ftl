...
cmd-help-help =
    Использование: { $command } [имя команды]
...
cmd-cvar-help =
    Использование: { $command } <имя | ?> [значение]
...
cmd-gc-help =
    Использование: { $command } [поколение]
...
cmd-exec-help =
    Использование: { $command } <имя файла>
...
cmd-cldbglyr-help =
    Использование: { $command } <layer>: Toggle <layer>
...
cmd-bind-help =
    Использование: { $command } { cmd-bind-arg-key } { cmd-bind-arg-mode } { cmd-bind-arg-command }
...
cmd-loglevel-help =
    Использование: { $command } <sawmill> <уровень>
...
cmd-testlog-help =
    Использование: { $command } <sawmill> <уровень> <сообщение>
...
cmd-entfo-help =
    Использование: { $command } <entityuid>
...
cmd-sggcell-help =
    Использование: { $command } <gridID> <vector2i>
