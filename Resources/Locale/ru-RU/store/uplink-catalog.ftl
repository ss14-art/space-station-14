...
uplink-syndimov-law-name = Набор плат законов «Синдимов»
uplink-syndimov-law-desc = Набор подрывных законов для случаев, когда вам нужно переманить ИИ на свою сторону; используйте при любой возможности. Поставляется с ID-картой Синдиката.
...
uplink-bulldog-bundle-desc = Компактный и злой: содержит популярный дробовик «Бульдог», один барабан 12 калибра с пулями и четыре барабана 12 калибра с картечью.
...
uplink-stimpack-desc = Легендарный химический коктейль, производимый компанией Donk Co. для Синдиката. Одна инъекция этого вещества увеличивает скорость бега и позволяет быстрее восстанавливаться после оглушения в течение 60 секунд.
