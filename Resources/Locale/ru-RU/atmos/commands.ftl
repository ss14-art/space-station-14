...
cmd-set-map-atmos-help = Использование: setmapatmos <mapid> <space> [<temperature> [moles...]]
...
cmd-set-map-atmos-hint-temp = <temperature> (число)
cmd-set-map-atmos-hint-gas = <{ $gas } моль> (число)
