...
alerts-changeling-chemicals-desc = Тратьте химикаты для использования своих способностей. Медленно восстанавливаются.
alerts-changeling-biomass-name = Биомасса
alerts-changeling-biomass-desc = Это ваше здоровье. Если оно достигнет 0 — [color=red]игра окончена[/color]. Поглощайте гуманоидов, чтобы восстановить её.
