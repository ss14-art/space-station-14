...
bounty-description-rollerskates = Служба безопасности Центком предложила новую стратегию, которая поможет офицерам одерживать верх в пеших погонях. Пришлите им одну пару, чтобы они поняли, насколько это ужасная идея.
