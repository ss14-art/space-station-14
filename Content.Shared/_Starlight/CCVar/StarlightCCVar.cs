...
public sealed partial class StarlightCCVars
{
    ...
    public static readonly CVarDef<string> LobbyChangelogsList =
        CVarDef.Create("lobby_changelog.list", "ChangelogOpenspace.yml,Changelog.yml", CVar.SERVER | CVar.REPLICATED);

    public static readonly CVarDef<string> ServerName =
        CVarDef.Create("lobby.server_name", "🪐 OpenSpace 🪐", CVar.SERVER | CVar.REPLICATED);
